...
public:
	...
	static sf::Texture& GetTexture(std::string const& filename, sf::IntRect rect); //Returns a reference to the texture, at the specified location, at the specified rect. Supported types are {.png}.
